"""Unit tests for the DeleteFollowerView."""
...
class RemoveFollowerViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse('delete-follower', kwargs={'pk': self.follower_object.pk})
        
    def test_url(self):
        url = '/delete-follower/1/'
    ...
    def test_form_removes_follower(self):
        ...
        self.assertEqual(str(messages[0]), "Follower deleted successfully!")
        
    def test_only_user_may_remove_follower(self):
