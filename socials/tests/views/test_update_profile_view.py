"""Unit tests for the Profile Update View"""
from django.contrib import messages
from django.test import TestCase
from django.urls import reverse
from socials.forms import UserForm
...
class EditProfileViewTest(TestCase):
    ...
    def test_profile_url(self):
        self.assertEqual(self.url, '/edit-profile/')

    def test_get_profile(self):
        self.client.login(username=self.user.username, password='Password123')
        response = self.client.get(self.url)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'account/edit-profile.html')
    ...
    def test_successful_profile_update(self):
        ...
        self.assertEqual(self.user.first_name, 'FOREVER')
        self.assertEqual(self.user.last_name, 'WOOO')
